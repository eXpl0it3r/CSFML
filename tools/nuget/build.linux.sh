...
copymodule()
{
    ...
    cp "$SFMLLibDir/libsfml-$MODULE.so.$SFMLMajorMinor" "$OutDir/libsfml-$MODULE.so.$SFMLMajorMinor"
    cp "$CSFMLLibDir/libcsfml-$MODULE.so" "$OutDir/libcsfml-$MODULE.so"
    cp "$CSFMLLibDir/libcsfml-$MODULE.so.$CSFMLMajorMinor" "$OutDir/libcsfml-$MODULE.so.$CSFMLMajorMinor"
}
