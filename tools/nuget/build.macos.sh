...
copymodule()
{
    ...
    cp "$CSFMLLibDir/libcsfml-$MODULE.dylib" "$OutDir/libcsfml-$MODULE.dylib"
    cp "$CSFMLLibDir/libcsfml-$MODULE.$CSFMLMajorMinor.dylib" "$OutDir/libcsfml-$MODULE.$CSFMLMajorMinor.dylib"
}
